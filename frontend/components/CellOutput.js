    ...
    constructor() {
        ...
        this.resize_observer = new ResizeObserver((entries) => {
            ...
            if (document.body.querySelector("pluto-cell:focus-within")) {
                ...
                if (!(document.activeElement.tagName == "SUMMARY") && !document.body.classList.contains('presentation') && (cell_outputs_after_focused.length == 0 || !Array.from(cell_outputs_after_focused).includes(this.base))) {
